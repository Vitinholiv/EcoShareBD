...
<body>
    ...
    <div id="content">
        ...
        <div class="form-container">
            ...
            <input type="text" id="inputFoto" placeholder="Foto do Item">
            <input type="text" id="inputDescricao" placeholder="Descrição do Item">
            <input type="text" id="inputNome" placeholder="Nome do Item">
            <input type="text" id="inputUsuarioi" placeholder="ID do usuário">
